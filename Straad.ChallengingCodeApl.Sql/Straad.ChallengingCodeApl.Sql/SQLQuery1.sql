...
SELECT * FROM PEDIDO
SELECT C.NOMBRE AS NOMBRE, SUM(P.TOTAL) AS MONTO_TOTAL FROM CLIENTE AS C INNER JOIN PEDIDO AS P ON C.CLIENTE_ID = P.CLIENTE_ID WHERE (PEDIDO BETWEEN '2023-01-01' AND '2023-12-31')  GROUP BY(C.NOMBRE)
